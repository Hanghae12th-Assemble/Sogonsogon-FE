...
function Lnb({ isOpen, handleItemClick }) {
    ...
    const [items, setItems] = useState([
        { id: 1, photo: <Home />, name: '홈', link: '/' },
        { id: 2, photo: <Music />, name: '음악', link: '/tag/음악' },
        { id: 3, photo: <Daily />, name: '일상', link: '/tag/일상' },
        { id: 4, photo: <Book />, name: '도서', link: '/tag/도서' },
        { id: 5, photo: <Asmr />, name: 'ASMR', link: '/tag/ASMR' },
    ]);
